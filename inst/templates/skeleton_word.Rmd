...
library(here)
library(flextable)
set_flextable_defaults(font.size = 11, padding = 3, big.mark = "")
# use_df_printer()
```
...
neartools::fake_snack_df %>%
  ...
  theme_vanilla() %>%
  autofit()  %>%
  set_table_properties(layout = "autofit", width = 0.8)# adjust this if the autofit generates too big tables
```
