...
* `get_label_df`: Get the labels of a dataframe. By filtering on the result, the users can quickly select the interested variables.
...
* `get_date_digit`: Get a date column's digit and find dates not having required digits.
