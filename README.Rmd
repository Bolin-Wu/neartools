...
* `get_pretty_template`: Automatically create & open an rmd file with a nice looking template. This facilitates the communication with researchers & tracking the records. User can choose output file to be word", "pdf" or "html". By default it complies an "html" file. 
...
* `get_all_colnames`: Gather multiple interested data files and examine their columns together.
